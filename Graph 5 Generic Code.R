...
funcReturnRevenueComparisionDf(dataset1,dataset2,dataset3,dataset4)

funcReturnRevenueComparisionDf   <- function(dataset1,dataset2,dataset3,dataset4){
coin=0
...
p = ggplot(DF1, aes(x = reorder(MarketPlace,-value), y = value/10000000, fill = variable)) + 
  geom_bar(stat = "identity") + 
  scale_y_continuous(labels = comma) +
  scale_fill_brewer(palette = "Set3") + ylab("Crores")+xlab("")

?annotation_custom
#hist(1:100)
p = p + labs(title = "Revenue Comparisions") +
  theme(
